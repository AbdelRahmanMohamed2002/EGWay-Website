...
<form action="edituser2.php?userid=<?php echo $f ?>" method="POST">
<div>
...
<div>
<a href="customer_service.php" class="button">book</a>
...
// $sql = "UPDATE $table SET `way` = '$way',`date` = '$date',`dat` = '$dat',`Time`='$Time',`Tim` = '$Tim',`Adults` = '$Adults',`child`='$child',`infant`='$infant',`class`='$class',`From1`='$From' WHERE `id` = $tmp"; 
