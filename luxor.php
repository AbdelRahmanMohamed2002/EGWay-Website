...
<input type="date" id="dat" name="dat" value="dat" min="2020-06-12" required>
</div>
<div>
...
$sql = " INSERT INTO `luxor`(`way`, `date`,  `dat`, `Time`, `Tim`, `Adults`, `child`, `infant`, `class`, `From1`,`id`) VALUES ('$way','$date','$dat','$Time','$Tim','$Adults','$child','$infant','$class','$From','')";
